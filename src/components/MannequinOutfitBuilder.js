  ...
  return (
    <div className="mannequin-builder">
      <div className="builder-content">
        {/* Main - Mannequin with Outfit Info */}
        <div className="mannequin-container">
          {/* Outfit Info Header */}
          <div className="outfit-info-header">
            <div className="outfit-details-compact">
              <h3>Current Outfit</h3>
              <div className="outfit-meta">
                <span><strong>Trip:</strong> {selectedTrip?.name || 'Select a trip'}</span>
                <span><strong>Outfit:</strong> {selectedOutfit}</span>
              </div>
              <input
                type="text"
                placeholder="Enter outfit name..."
                className="outfit-name-input-compact"
                defaultValue={`${selectedTrip?.name || 'Trip'} - Outfit ${selectedOutfit}`}
              />
            </div>

            <div className="outfit-actions-compact">
              <button className="save-btn-compact" onClick={handleSaveOutfit}>
                💾 Save
              </button>
              <button className="clear-btn-compact" onClick={() => setCurrentItems({ hat: null, top: null, bottom: null, shoes: null })}>
                🗑️ Clear
              </button>
            </div>
          </div>

          {/* Mannequin Content Area */}
          <div className="mannequin-content">
